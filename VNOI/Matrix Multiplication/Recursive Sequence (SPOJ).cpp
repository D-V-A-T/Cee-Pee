...
const ll N = 3e5 + 69, MOD = 1e9, INF = 1000000000000000069;
...
void sol(){
	...
	matrix base(k, vect<int>(k));

	for(long i=0;k>i+1;i++) base[i][i+1] = 1;
	base[k-1] = c;
	...
	matrix final = mul(Mp(base, n-k), b);
	cout << final[k-1][0] << el;
