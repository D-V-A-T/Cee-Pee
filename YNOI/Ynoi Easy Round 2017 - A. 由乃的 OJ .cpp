...
struct Seggs{
    ...
    void build(int l=0, int r=n-1, int id=1){
        ...
        // cout << t[id].r1 << ' ' << t[id*2].r1 << ' ' << t[id*2+1].r1 << " (" << l << ' ' << mid << ") " << " (" << mid+1 << ' ' << r << ")" << el;
    ...
    void query(int i, int j, ull& zero, ull& one, bool merge_left, int l=0, int r=n-1, int id=1){
        ...
        if(i <= l && r <= j){
            ...
            // cout << i << ' ' << j << ' ' << zero << ' ' << one << ' ' << merge_left << el;
            // cout << t[id].l1 << el;
            ...
            if(merge_left){
                ...
                // cout << ((t[id].r0)) << ' ' << (curr_one & t[id].r1) << el;
                zero = final;
            ...
            // cout << zero << ' ' << one << ' ' << l << ' ' << r << ' ' << merge_left << el;
...
ull query(int a, int b, ull z, Seggs& sgt){
    ...
    // cout << head[a] << ' ' << depth[a] << ' ' << depth[b] << ' ' << head[b] << ' ' << parent[head[a]] << el;
    // deb 0;
    ...
    while(head[a] != head[b]){
        if(depth[head[a]] >= depth[head[b]]){
            ...
            // sgt.query(pos[head[b]], pos[b], zero, one, true);
            b = parent[head[b]];
        }
        // cout << "! " << zero << ' ' << one << el;
        in_loop = 1;
