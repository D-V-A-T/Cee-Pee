...
struct DSU{
    ...
    void join(int u, int v){
        if(!par.count(u) || !par.count(v)) return;
...
void Alob(){
    ...
    for(int& i : T) cin >> i, ds.create_node(i);
...
void Bice(){
    ...
    set<int> seen;
    DSU ds;
    for(int &i : R) cin >> i, ds.create_node(i);
